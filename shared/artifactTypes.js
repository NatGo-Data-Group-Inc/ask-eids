const SOURCE_TYPES = {
  ...
  product_charter: { label: 'product charter', family: 'document', binary: false, structured: false },
  architecture_doc: { label: 'architecture document', family: 'document', binary: false, structured: false },
  stakeholder_roster: { label: 'stakeholder roster', family: 'document', binary: false, structured: false },
  roadmap: { label: 'roadmap', family: 'document', binary: false, structured: false },
  product_brief: { label: 'product brief', family: 'document', binary: false, structured: false },
  handoff_memo: { label: 'handoff memo', family: 'document', binary: false, structured: false },
...
const EXTENSION_RULES = {
  ...
  '.docx': { allowedTypes: ['document', 'product_charter', 'architecture_doc', 'handoff_memo', 'decision_memo', 'release_plan', 'weekly_update', 'transcript'], defaultType: 'document', locked: false, reviewRequired: true },
  '.eml': { allowedTypes: ['email'], defaultType: 'email', locked: true, reviewRequired: false },
  '.md': { allowedTypes: ['document', 'stakeholder_roster', 'roadmap', 'product_brief', 'weekly_update', 'decision_log', 'release_plan', 'transcript'], defaultType: 'document', locked: false, reviewRequired: true },
