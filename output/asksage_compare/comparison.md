...
## Run Metadata
- baseline_dir: output/asksage_harness_local
- candidate_dir: output/asksage_harness
- baseline_mode: local
- candidate_mode: asksage
- baseline_type: governance_repeatability
- candidate_type: operational_reasoning

## Prompt Comparisons
### bedrock_transition_recommendation
- status: changed
- baseline_present: True
- candidate_present: True
- baseline_chars: 265
- candidate_chars: 4052
- diff_line_count: 71

```diff
--- bedrock_transition_recommendation:baseline
+++ bedrock_transition_recommendation:candidate
@@ -1,5 +1,65 @@
+
+
...
- candidate_present: True
- baseline_chars: 364
- candidate_chars: 3749
- diff_line_count: 91

```diff
--- cost_anomaly_detection:baseline
+++ cost_anomaly_detection:candidate
@@ -1,10 +1,80 @@
-# Cost Anomaly Detection
 
-- Rows analyzed: 250
-- High or medium anomalies: 28
-- Highest cost service: AmazonEMR at $54,650.43
 
-## Representative anomalies
-- AmazonEMR in us-gov-west-1: missed shutdown automation at $1,840.22
-- AmazonEMR in us-gov-west-1: missed shutdown automation at $1,732.18
-- AmazonEMR in us-gov-east-1: missed shutdown automation at $2,405.54
...
- candidate_present: True
- baseline_chars: 206
- candidate_chars: 3488
- diff_line_count: 93

```diff
--- fte_replacement_roi:baseline
+++ fte_replacement_roi:candidate
@@ -1,5 +1,86 @@
-# FTE Replacement ROI
 
-- Estimated analyst hours saved per review cycle: 56
-- Basis: 28 anomalies summarized from 250 rows
...
- candidate_present: True
- baseline_chars: 249
- candidate_chars: 2947
- diff_line_count: 72

```diff
--- pmo_executive_summary:baseline
+++ pmo_executive_summary:candidate
@@ -1,6 +1,64 @@
-# PMO Executive Summary
 
-- Synthetic rows reviewed: 250
-- Anomalies requiring attention: 28
-- Highest cost concentration: AmazonEMR at $54,650.43
...
### technical_debt_correlation
- status: changed
- baseline_present: True
- candidate_present: True
- baseline_chars: 258
- candidate_chars: 4199
- diff_line_count: 87

```diff
--- technical_debt_correlation:baseline
+++ technical_debt_correlation:candidate
@@ -1,8 +1,78 @@
